...
const {requireInGuild, requireChaosPermission} = require('./middleware.js');
const router = express.Router();

router.get('/plugins/:pluginName/actions', async (req, res, next) => {
  try {
...
router.patch('/:guildId/plugins/:pluginName',
...
router.post('/:guildId/plugins/:pluginName/:actionName',
  requireInGuild((req) => req.params.guildId),
  requireChaosPermission('admin'),
  async (req, res, next) => {
    try {
